...
import com.codepath.bestsellerlistapp.networking.NYTimesService
...
class NYTimesApiClient {
    ...
    fun getBestSellersList(booksListResponse: CallbackResponse<List<BestSellerBook?>?>) {
        ...
        current.enqueue(object : Callback<NYTimesAPIResponse?> {
            override fun onResponse(
                call: Call<NYTimesAPIResponse?>,
                response: Response<NYTimesAPIResponse?>
            ) {
    ...
    companion object {
        ...
        private const val API_KEY = "6Ae8MeonOIA1SA02ZAYRJrhDNgbFt5cw"
    }
